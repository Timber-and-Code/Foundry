...
export const WARMUP = [
  { load: "Bar only", reps: "10", note: "Neural activation — feel the groove, zero load." },
...
export const CARDIO_WORKOUTS = [
  {
    id: "easy_walk",
    name: "Easy Walk",
    desc: "Low-intensity steady state. Improves aerobic base, recovery-friendly.",
    duration: "30–45 min",
  ...
  },
  {
    id: "zone2_run",
    name: "Zone 2 Run",
    desc: "Build aerobic engine. Sweet spot for fat loss and endurance.",
    duration: "30–50 min",
    intensity: "70–75% max HR",
    effort: "Can speak in short sentences",
  },
  {
    id: "tempo_run",
    name: "Tempo Run",
    desc: "Threshold work. Improves lactate clearance and work capacity.",
    duration: "20–30 min",
    intensity: "80–85% max HR",
    effort: "Tough, but sustainable",
  },
  {
    id: "hiit_bike",
    name: "HIIT Bike (Tabata)",
    desc: "Max effort intervals. Boosts VO2 max and metabolic conditioning.",
    duration: "15–20 min",
    intensity: "95–100% max HR",
    effort: "All-out sprints with short rest",
  },
  {
    id: "long_steady",
    name: "Long Steady State",
    desc: "Build mental toughness and aerobic depth. Often weekend session.",
    duration: "60–90 min",
    intensity: "65–75% max HR",
    effort: "Conversational, meditative",
  },
  {
    id: "swim",
    name: "Steady Swim",
    desc: "Low-impact, full-body cardio. Great for recovery and accessory work.",
    duration: "30–45 min",
    intensity: "70–80% max HR",
    effort: "Steady, rhythmic",
  },
  {
    id: "jump_rope",
    name: "Jump Rope Circuit",
    desc: "High coordination, calorie burn. Keep rest short.",
    duration: "15–20 min",
    intensity: "75–90% max HR",
    effort: "Fast-paced, maintain rhythm",
  },
];
...
export const MOBILITY_PROTOCOLS = [
  {
    ...
    duration: "15 min",
    moves: [
      { name: "Shoulder Dislocations", reps: "12 each direction", cue: "Light band or dowel. Start narrow, move through full range." },
      { name: "Wall Slides", reps: "15", cue: "Back against wall, slide arms up and down, keeping contact." },
      { name: "YTWs", reps: "10 each position", cue: "Prone, form Y, T, W shapes. Light weight or bodyweight." },
      { name: "Dead Hangs", reps: "30 sec hold", cue: "Relax shoulders into stretch. 3 sets." },
    ],
  },
  {
    id: "hip_mobility",
    ...
    duration: "20 min",
    moves: [
      { name: "90/90 Stretch", reps: "45 sec each side", cue: "One leg forward, one to side, fold gently over front leg." },
      { name: "Pigeon Pose", reps: "60 sec each side", cue: "Quad stretched leg in back, hip-opener leg in front. Relax torso forward." },
      { name: "World's Greatest Stretch", reps: "5 each side", cue: "Lunge, rotate, touch ground. Hits everything." },
      { name: "Lizard Pose", reps: "45 sec each side", cue: "Low lunge, forearms down. Feel the groin and hip flexor." },
    ],
  },
  {
    ...
    duration: "10 min",
    moves: [
      { name: "Dead Hangs", reps: "30 sec × 3", cue: "Let gravity do the work. Relax." },
      { name: "Child's Pose", reps: "60 sec", cue: "Wide knees, sink hips, breathe into lower back." },
      { name: "Sphinx Pose", reps: "30 sec × 2", cue: "Gentle backbend on forearms. Don't force extension." },
      { name: "Box Breathing", reps: "5 min", cue: "4 count in, 4 hold, 4 out, 4 hold. Settle the nervous system." },
    ],
  },
  {
    id: "full_body_flow",
    ...
    moves: [
      ...
      { name: "Inchworms", reps: "8", cue: "Walk hands out to plank, walk feet to hands, stand." },
      { name: "World's Greatest Stretch", reps: "3 each side", cue: "Lunge, rotate, reach. Covers everything." },
      { name: "Downward Dog to Upward Dog", reps: "10", cue: "Alternate between poses, breathe steadily." },
      { name: "Walking Lunges with Twist", reps: "10 each leg", cue: "Step, rotate torso, feel the hip opening." },
      { name: "Spinal Twists", reps: "30 sec each side", cue: "Lying on back, pull one knee across, let gravity twist." },
    ],
  },
];
...
export function resetMesoCache() { _mesoCache = null; }

// Convenience getters for commonly imported derived values
export function getWeekPhase() { return getMeso().phases; }
export function getWeekRir() { return getMeso().rirs; }
...
export function randomCongrats() { return CONGRATS[Math.floor(Math.random() * CONGRATS.length)]; }
