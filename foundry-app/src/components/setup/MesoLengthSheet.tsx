...
/**
 * MesoLengthBody — reusable picker body for mesocycle length.
 * Rendered inline inside the Beat 2 AccordionBar.
 */
export function MesoLengthBody({ current, onSelect }: MesoLengthBodyProps) {
  return (
...
/**
 * MesoLengthSheet — legacy bottom-sheet wrapper for mesocycle length.
 * Beat 2 now consumes `MesoLengthBody` directly inside an AccordionBar.
 */
