    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', padding: '8px 0 4px' }}>
          ...
          >
            The Foundry plans your training, auto-progresses your weights, and tracks every set — so
            you can just show up and lift.
          </div>
        </div>
        ...
        >
          ...
          <div
            style={{
              borderTop: '1px solid var(--phase-peak)22',
          ...
          >
            ...
            >
              Your second program isn't built from scratch — it's built from your actual meso 1
              data. Peak weights, volume, stalling patterns, and your recovery profile.{' '}
              <strong style={{ color: 'var(--text-primary)' }}>
                The Foundry knows what you lifted.
              </strong>
            </div>
          </div>
            ...
            {submitted ? (
              ...
              >
                ...
                <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
                  Check your inbox to confirm — then you're in.
                </div>
              </div>
            ) : (
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
                For coaches and gym professionals
              </div>
            </div>
          </div>
          <div
          ...
          >
            {[
              ...
              'Coach notes per client session',
              'Everything in Pro',
            ].map((f, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                <svg
                ...
                <span
                  style={{
                    fontSize: 13,
                    color: i === 3 ? 'var(--text-muted)' : 'var(--text-secondary)',
                    lineHeight: 1.4,
                  }}
                >
                  {f}
        ...
        >
          ...
          >
            Most systems fail people — and that failure is exactly what keeps so many from becoming
            who they want to be. Not lack of effort. Not lack of heart. The system let them down.
            I've lived that. I've watched people I care about live that. And I got tired of it.
          </p>
          <p
            style={{
              fontSize: 13,
          ...
          >
            The Foundry is my answer to that. Not just a tracker, not just a program — a system that
            thinks ahead, holds the line, and refuses to let you down. One that meets you where you
            are and walks every rep of the journey with you.
          </p>
          <p
            style={{
              fontSize: 13,
          ...
          >
            My goal is to live past 100. Not just exist — thrive. Strong, sharp, and fully alive for
            every year of it. And the more people I can bring with me on that journey, the better
            off every single one of us will be.
          </p>
          <p
            style={{
              fontSize: 13,
