...
import { TAG_COLORS } from './ExerciseDetailModal';
...
function StartSampleProgramModal({
  prog,
  hasActiveMeso,
  onConfirm,
  onCancel,
...
export function SamplePrograms({ profile, onStartProgram, onBack }: SampleProgramsProps) {
  const [expandedProgram, setExpandedProgram] = useState<string | null>(null);
  const [startModalProg, setStartModalProg] = useState<(typeof SAMPLE_PROGRAMS)[number] | null>(null);
