...
import type { WarmupStep } from '../../utils/training';
...
interface ExerciseCardProps {
  ...
  onWeightAutoFill: (exIdx: number, weight: number | string, numSets: number) => void;
  ...
  note: string;
  onNoteChange: (exIdx: number, val: string) => void;
}
