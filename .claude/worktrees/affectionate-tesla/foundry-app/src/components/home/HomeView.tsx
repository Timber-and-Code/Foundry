...
import type { NoteViewerData } from './ScheduleTab';
...
interface HomeViewProps {
  tabRef: MutableRefObject<((key: string) => void) | null>;
  currentWeek: number;
  ...
  onOpenCardio: (dateStr: string, protocolId?: string) => void;
...
function HomeView({
  ...
  const [showRestDay, setShowRestDay] = useState<number | null>(null);
