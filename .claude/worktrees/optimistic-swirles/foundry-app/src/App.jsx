  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Global minimized timer bar — subscribes to context, does not re-render App on tick */}
        <GlobalTimerBar
          onNavigate={(ref) => {
...
// ── GlobalTimerBar — subscribes to RestTimerContext; only this component re-renders on tick ──
function GlobalTimerBar({ onNavigate }) {
  const { restTimer, restTimerMinimized, dismissRestTimer, timerDayRef, setRestTimerMinimized } =
    useRestTimer();
  if (!restTimer || !restTimerMinimized) return null;
  return (
    <MinimizedTimerBar
      restTimer={restTimer}
      onTap={(done) => {
