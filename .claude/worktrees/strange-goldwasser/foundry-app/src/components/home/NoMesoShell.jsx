    ...
    <div style={{
      ...
      <div style={{flex:1, overflowY:"auto", paddingBottom:100}}>
        ...
        <div style={{
          ...
          background:"radial-gradient(ellipse at center bottom, rgba(232,101,26,0.08) 0%, transparent 70%)",
        }}>
          <img src={typeof FOUNDRY_EMPTY_IMG !== 'undefined' ? FOUNDRY_EMPTY_IMG : ''} alt=""
            style={{width:180, height:180, objectFit:"cover", marginBottom:12, borderRadius:16,
      ...
      <div style={{
        ...
        <button onClick={onSetup} className="btn-primary" style={{
