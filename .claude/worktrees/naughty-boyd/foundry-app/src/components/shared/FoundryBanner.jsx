  ...
  return (
    <div style={{
      ...
      <div style={{display:"flex", alignItems:"center", gap:12}}>
        <img src={typeof FOUNDRY_ANVIL_IMG !== 'undefined' ? FOUNDRY_ANVIL_IMG : ''} alt="" style={{width:40, height:40, objectFit:"cover", borderRadius:8, flexShrink:0, boxShadow:"0 0 16px rgba(232,101,26,0.2)"}} />
        <div>
        <div style={{
        ...
        {subtitle && (
          <div style={{
            ...
            color: "var(--phase-accum)", marginTop: 3,
      ...
      {onProfileTap && (
        <button onClick={onProfileTap} style={{
          ...
          color: "#C0885A", transition: "color 0.15s",
        }}
